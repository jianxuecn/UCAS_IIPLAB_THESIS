...
\degreetype{工学}% 学位类别：理学、工学、工程、医学、工程管理等
%\degreetype{工程管理}% 学位类别为工程管理
\major{计算机应用技术}% 二级学科专业名称
%\major{工业工程与管理}% 二级学科为工业工程与管理
...
%\DEGREETYPE{Philosophy}% 工学博士学位
%\DEGREETYPE{Engineering Management}% 学位类别为工程管理
\MAJOR{Computer Applied Technology}% 二级学科专业名称
%\MAJOR{Industrial Engineering and Management}% 二级学科为工业工程与管理
